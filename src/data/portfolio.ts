...
export const metrics = [
  ...
  { value: '8+', label: 'Industries Worked In' },
  { value: '100%', label: 'Focus on Impact' },
  { value: '72%', label: 'RAG Storage Reduction' },
]
...
export const experience: ExperienceItem[] = [
  {
    ...
    headline:
      "Sole architect and technical owner of the company's entire agentic AI infrastructure - 4 production agents, custom A2A protocol, and full GCP deployment.",
    context:
      'Sapience AI is a SaaS platform for member and corporate intelligence. The engineering challenge was to design and build a complete multi-agent backend from scratch on GCP, serving multiple organisations from day one.',
    bullets: [
      ...
      'Built independent Cloud Run services with Firestore state, Cloud Storage document ingestion, Secret Manager credentials, Cloud IAM, Cloud Build, Artifact Registry, Cloud Trace, and Cloud Logging.',
      'Mentored the engineering team on LangGraph patterns, async Python, production error handling, and LLM observability.',
    ],
    systems: [
      {
        title: 'Membership Intelligence Agent',
        detail: 'ReAct-based tool calling with HubSpot CRM, LangGraph, Vertex AI, member engagement tracking, affinity analysis, and org-scoped filtering.',
      },
      {
        title: 'Corporate Research Agent',
        detail: 'Multi-tool orchestration using Tavily search, yfinance market data, entity extraction, sponsor tracking, and financial research across 21 public companies.',
      },
      {
        title: 'Enterprise RAG Agent',
        detail: 'Stateful LangGraph workflow with Qdrant hybrid search, SPLADE++ sparse vectors, server-side RRF, Firestore-backed session memory, and multi-format ingestion.',
      },
      {
        title: 'Social Media Agent',
        detail: 'LinkedIn content workflow with Gemini 2.5 Flash, Anthropic Claude fallback, draft preview, and human-in-the-loop confirmation before posting.',
      },
    ],
    achievements: [
      '72% vector storage reduction with scalar INT8 quantisation',
      'Org-scoped isolation across services and retrieval operations',
      'End-to-end LLM tracing from user request to model inference',
      'Two-tier cache with stale-while-refresh and jitter',
    ],
  },
  {
    id: 'unstructured',
    ...
    headline:
      'Fine-tuned vision-language models for document intelligence and built structured extraction pipelines.',
    context:
      'Worked across document intelligence, vision-language models, NLP, and enterprise RAG systems, translating messy document layouts into reliable structured extraction workflows.',
    bullets: [
      ...
      'Contributed to prompt engineering and document-metadata enrichment pipelines for LLM-based extraction tasks.',
      'Improved structured output reliability across diverse document types through curation, evaluation, and model-selection loops.',
    ],
    systems: [
      {
        title: 'Donut VLM Fine-tuning',
        detail: 'Fine-tuned transformer-based vision-language models for invoices, receipts, simple forms, and diverse document layouts.',
      },
      {
        title: 'Key-Value Extraction',
        detail: 'Combined XGBoost, sentence embeddings, and NLP feature engineering for form field extraction from complex images.',
      },
      {
        title: 'Financial RAG Chunking',
        detail: 'Designed chunking strategies and evaluation workflows for financial Q&A retrieval pipelines, contributing to the 2024 arXiv publication.',
      },
    ],
    achievements: [
      '90%+ accuracy on simple document layout parsing',
      '40% to 76% form extraction accuracy lift',
      'Financial Report Chunking for Effective RAG publication',
    ],
  },
  {
    id: 'dlr',
    ...
    headline:
      'Modelled medical record de-identification as conditional text generation using a generative VAE model.',
    context:
      'Research role in a high-security environment focused on privacy-preserving NLP, healthcare AI, and synthetic medical record generation.',
    bullets: [
    ...
    systems: [
      {
        ...
        detail: 'Conditional generation approach for medical de-identification, designed to enable research without exposing real patient records.',
      },
    ],
    achievements: [
      'Dockerized end-to-end synthetic record generation',
      'VAE with holistic discriminators for de-identification',
    ],
  },
  {
    id: 'webis',
    ...
    headline:
      'Developed multilingual classifiers and code generation pipelines using Transformer models.',
    context:
      'Academic research in information retrieval, NLP, code generation, text classification, and active learning at Bauhaus-Universitat Weimar.',
    bullets: [
    ...
    systems: [
      {
        ...
        detail: 'BERT-based active learning system for multilingual classification across 100 categories with reduced dependence on labelled data.',
      },
      {
        title: 'Neural Code Generation',
        detail: 'Natural language to Python generation experiments with transformer-based neural networks.',
      },
    ],
    achievements: [
      '90%+ accuracy across 100 categories',
      '70% political inclination classifier accuracy',
    ],
  },
  {
    id: 'omdena',
    ...
    headline:
      'Delivered collaborative ML prototypes for renewable energy, harassment classification, and planetary science.',
    context:
      'Collaborative AI-for-good work across applied machine learning, social impact, anomaly detection, and NLP.',
    bullets: [
      ...
      'Mentored the Python4AI webinar series as part of the Renewable Africa academy program.',
    ],
    systems: [
      {
        title: 'Safecity NLP Classifier',
        detail: 'Automatic classification system for sexual harassment reports using NLP in support of the Red Dot Foundation.',
      },
      {
        title: 'Mars Anomaly Detection',
        detail: 'Deep adversarial training approach for anomaly detection in planetary science data.',
      },
    ],
    achievements: [
      '3 AI-for-good projects delivered',
      'Technical articles on NLP and anomaly detection',
    ],
  },
  {
    id: 'consultant',
    ...
    context:
      'Early professional foundation in business intelligence, reporting automation, and dashboard design for data-intensive business processes.',
    bullets: [
      ...
      'Delivered data-driven intelligence tools across multiple client verticals.',
    ],
    systems: [
      {
        title: 'BI Automation Workflows',
        detail: 'Microsoft services, SQL queries, dashboard automation, and KPI visualisation for operational reporting.',
      },
    ],
    achievements: [
      'Broader professional foundation from 2012',
      'Multiple business intelligence client verticals',
    ],
  },
]
...
export const projects = [
  {
    ...
    company: 'Sapience AI',
    description:
      'Sole architect of 4 production agents: Membership Intelligence (HubSpot + ReAct), Corporate Research (Tavily + yfinance, 21 companies), Enterprise RAG Agent, and Social Media Agent with LinkedIn integration and stateful approval workflows.',
  ...
  },
  {
    ...
    company: 'Sapience AI',
    description:
      'Combined 768-dim dense vectors (text-embedding-005) with SPLADE++ sparse vectors and server-side RRF in Qdrant. Scalar INT8 quantisation. Two-tier query caching (soft/hard TTL, stale-while-refresh, jitter).',
  ...
  },
  {
    ...
    company: 'Sapience AI',
    description:
      'Custom Pydantic-based microservice orchestration framework with JWT authentication, org-scoped multi-tenancy, and SSE event streaming. Type-safe, independently deployable agent services.',
  ...
  },
  {
    ...
    company: 'Unstructured Technologies',
    description:
      'Fine-tuned Donut (vision-language transformer) on proprietary document datasets to parse diverse layouts into structured JSON. Progressive optimisation with high-resolution PDF partitioning strategies.',
  ...
  },
  {
    ...
    company: 'Unstructured Technologies',
    description:
      'Trained lightweight classifiers combining XGBoost + sentence embeddings + NLP features for key-value extraction from complex form images. Iterative feature engineering and data-driven model selection.',
  ...
  },
  {
    ...
    description:
      'Modelled medical record de-identification as conditional text generation using a VAE with holistic discriminators. Dockerized end-to-end solution for synthesising privacy-compliant records conditioned to patient profiles.',
